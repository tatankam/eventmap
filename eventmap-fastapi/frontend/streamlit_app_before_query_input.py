...
def main():
    ...
    with col1:
        ...
        if error_msgs:
            ...
            # Proceed with using startinputdate and endinputdate

        search_disabled = len(error_msgs) > 0  # True if there are validation errors
    ...
    with col2:
        if data:
            ...
            if data.get('buffer_polygon'):
                try:
                    ...
                    folium.GeoJson(
                        ...
                        #style_function=lambda x: {'color': '#ff4500', 'weight': 3, 'fillColor': '#ffa07a', 'fillOpacity': 0.15}
            ...
            # Add event markers with info popups
